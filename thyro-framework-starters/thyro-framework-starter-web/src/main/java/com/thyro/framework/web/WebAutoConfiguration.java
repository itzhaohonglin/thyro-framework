...
import com.thyro.framework.web.datetime.DateTimeConfig;
import com.thyro.framework.web.datetime.DateTimeConvertPrimaryConfig;
import com.thyro.framework.web.exception.GlobalExceptionHandler;
import com.thyro.framework.web.exception.GlobalResponseBodyHandler;
...
@ComponentScan(basePackages = "${thyro.base-package:com.thyro.framework.**.web}")
@Import({InitializingAdviceDecorator.class,
        GlobalExceptionHandler.class, SentinelBlockExceptionHandler.class,
        DateTimeConfig.class, TransformConfig.class, DateTimeConvertPrimaryConfig.class})
